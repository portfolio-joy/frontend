...
export default function* saveAboutMeSaga(action : { type: string; payload: { data: AboutMeType, id: string, token: string, profile : File } }): Generator<CallEffect<Response> | PutEffect | Promise<string>, void, AboutMeType> {
    try {
        console.log("Reached Save about me saga");
